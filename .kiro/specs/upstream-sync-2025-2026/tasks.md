...
- [ ] 4. Cherry-pick structural cleanups
  ...
  - [-] 4.4 Remove redundant sleep delays from color pipeline
...
- [ ] 6. Cherry-pick new features
  ...
  - [~] 6.6 Import Emoji 17.0 data update
...
- [~] 7. Checkpoint — New features imported
  - Ensure all feature cherry-picks apply cleanly, ask the user if questions arise.

- [ ] 8. Lua keybinds migration adaptation
  - [~] 8.1 Analyze upstream keybinds.lua for new/changed bindings
  ...
  - [~] 8.2 Update keybinds.conf.template with upstream logical changes
  ...
  - [~] 8.3 Verify keybind equivalence between Lua source and conf.template
...
- [~] 10. Checkpoint — Module extensions complete
  - Ensure all new options are wired correctly, ask the user if questions arise.

- [ ] 11. Preserve custom NixOS adaptations
  - [~] 11.1 Verify applycolor.sh custom functions intact
  ...
  - [~] 11.2 Verify RGB lighting, idle panel, and AppLauncher patch preserved
  ...
  - [~] 11.3 Verify systemd service and overlay configurations
...
- [ ] 12. Build testing and verification
  - [~] 12.1 Run `home-manager build` on sync branch
  ...
  - [~] 12.2 Verify template placeholder integrity
  ...
  - [~] 12.3 Verify custom config persistence mechanism
  ...
  - [~] 12.4 Write property test for template placeholder integrity (Property 1)
  ...
  - [~] 12.5 Write property test for wallpaper variant selection (Property 2)
  ...
  - [~] 12.6 Write property test for custom keybind injection (Property 4)
