...
- [ ] 1. Configuration Extensions
  - [ ] 1.1 Add voice assistant config keys to Config.qml
...
- [ ] 2. Intent Classifier
  - [ ] 2.1 Implement heuristic intent classification in DictationService
  ...
  - [ ] 2.2 Implement AI-based intent classification (optional mode)
...
- [ ] 3. Free Dictation Session
  - [ ] 3.1 Add session management functions to Ai.qml
  ...
  - [ ] 3.2 Prevent deletion of Free Dictation session in UI
  ...
  - [ ] 3.3 Add re-send capability for Free Dictation messages
...
- [ ] 4. ActionPalette Direct Execution
  - [ ] 4.1 Add submitQueryDirect function to ActionPalette
  ...
  - [ ] 4.2 Implement auto-execution of safe actions
  ...
  - [ ] 4.3 Add voice assistant system prompt constant
...
- [ ] 5. Voice Assistant Pipeline
  - [ ] 5.1 Implement _processVoiceAssistant function in DictationService
  ...
  - [ ] 5.2 Handle ActionPalette response in voice assistant mode
  ...
  - [ ] 5.3 Handle ActionPalette errors and timeouts
...
- [ ] 6. TTS Engine
  - [ ] 6.1 Create TtsService.qml singleton
  ...
  - [ ] 6.2 Implement piper TTS backend
  ...
  - [ ] 6.5 Implement stop and interrupt behavior
  ...
  - [ ] 6.6 Handle TTS errors gracefully
...
- [ ] 7. Floating Response Indicator
  - [ ] 7.1 Extend DictationIndicator with VoiceResponse state
  ...
  - [ ] 7.4 Add TTS playback animation
    - While `TtsService.playing`, show a speaker/volume wave animation icon next to response text
    - File: `ii/modules/dictation/DictationIndicator.qml`
    - _Requirements: 3.5_

- [ ] 8. Provider Settings UI
  - [ ] 8.1 Create VoiceAssistantConfig.qml settings component
  ...
  - [ ] 8.4 Add default endpoint placeholder text
...
- [ ] 9. Policy Enforcement
  - [ ] 9.1 Add policy checks to voice assistant pipeline
...
- [ ] 10. STT Provider Fallback Chain
  - [ ] 10.1 Implement STT endpoint fallback in DictationService
...
- [ ] 11. Integration & Wiring
  - [ ] 11.1 Wire voice assistant pipeline into existing _handleTranscriptionResult
  ...
  - [ ] 11.2 Wire TTS stop on new dictation activation
    - In `activate()`, call `TtsService.stop()` before starting a new session
    - File: `ii/services/DictationService.qml`
    - _Requirements: 3.6_

  - [ ] 11.3 Wire ActionPalette approval signal to DictationService
...
- [ ] 12. Testing
  - [ ] 12.1 Write property tests for intent classifier
  ...
  - [ ] 12.2 Write integration test for TTS pipeline
  ...
  - [ ] 12.3 Write test for Free Dictation session management
