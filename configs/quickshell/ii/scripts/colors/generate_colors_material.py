...
if args.termscheme is not None:
    ...
    primary_color_argb = hex_to_argb(material_colors.get('primaryPaletteKeyColor', material_colors.get('primary_paletteKeyColor', material_colors.get('primary', '#6750A4'))))
